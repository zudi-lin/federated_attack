...
class FederatedCIFAR10(VisionDataset):
    ...
    def __init__(self, root, train=True,
                 ...
                 download=False, sample_type='random'):

        super(FederatedCIFAR10, self).__init__(root)
        ...
        # prepare data under fedrated learning setting
        assert sample_type in ['random', 'class']
        self.sample_type = sample_type
        self._prepare_fedrated()
    ...
    def __getitem__(self, index):
        ...
        """
        img, target = self.fedrated_data[index], self.fedrated_targets[index]
